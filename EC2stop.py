        ...
        for value in running_instances:
            ...
            for reservation in instances['Reservations']:
                for instance in reservation['Instances']:
                    instance_id = instance['InstanceId']                                                                                    public_ip = instance['PublicIpAddress']                                                                                 print(f' instance is : {instance_id},{public_ip}')
                    ec2.stop_instances(InstanceIds=[instance_id])
                print("------------------------------------------------------------------")                                             print("stopping only running instances with provided tag")
